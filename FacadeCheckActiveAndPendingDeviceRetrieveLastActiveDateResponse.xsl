							...
							<serviceResponse>
								...
								<xsl:choose>
									<xsl:when test="'' != id">
										...
										<accountNo><xsl:value-of select="accountList/account/number" /></accountNo>
										<commonErrors>
											<serviceComponent></serviceComponent>
										</commonErrors>
										<deviceDetailsList>
											<deviceDetailsLineItem>
												<lastActiveDate><xsl:value-of select="accountList/account/lineList/line/device/deviceActivationDate" /></lastActiveDate>
												<activeAtSwitchIndicator><xsl:value-of select="accountList/account/lineList/line/device/simCardDisconnectIndicator" /></activeAtSwitchIndicator>
												<mtn><xsl:value-of select="accountList/account/lineList/line/mdn" /></mtn>
											</deviceDetailsLineItem>
										</deviceDetailsList>
									</xsl:when>
									<xsl:otherwise>
